...
import '../../notifier/qr_code_scanner_notifier.dart';
...
class QrCodeScannerScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final qrProvider = ref.watch(qrCodeScannerProvider);
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (result != null)
                    ...
                    const Text('Scan a code - discontinued package'),
                  Row(
  ...
  Widget _buildQrView(BuildContext context) {
    ...
    return StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) => QRView(
              key: qrKey,
